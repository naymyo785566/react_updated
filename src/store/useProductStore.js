...
const useProductStore = create(()=> ({
    ...
    products: [
        ...
        },
        {
            ...
            "slug": "wd-4tb-gaming-drive-works-with-playstation-4"
        },
        {
            "id": 13,
        ...
        },
        {
            ...
            "price": 999.99,
            "description": "49 INCH SUPER ULTRAWIDE 32:9 CURVED GAMING MONITOR with dual 27 inch screen side by side, Quantum Dot (QLED) technology, HDR support and factory calibration provides stunningly realistic and accurate color and contrast. 144Hz high refresh rate and 1ms ultra-fast response time minimizes image lag and motion blur for fast action gaming.",
            "category": "electronics",
        ...
        },
        {
            ...
            "price": 29.95,
            "description": "100% POLYURETHANE (shell) 100% POLYESTER (lining) 75% POLYESTER 25% COTTON (Sweater), Faux leather material for style and comfort / 2 pockets of front, 2-For-One Hooded denim style faux leather jacket (above the knee length).",
            "category": "women's clothing",
        ...
        },
        {
            ...
            "price": 39.99,
            "description": "Lightweight perfect for trip or casual wear—Long sleeve with hooded, adjustable drawstring waist design. Waterproof and windproof. Casual loose fashionable style.",
            "category": "women's clothing",
        ...
        },
        {
            ...
            "price": 9.85,
            "description": "95% RAYON 5% SPANDEX—Made in USA or Imported—Pull On closure—Machine Wash—FABRIC: Lightweight fabric with great stretch for comfort—NECKLINE: Deep V-Neckline / CARE: Hand wash cold, dry flat",
            "category": "women's clothing",
        ...
        },
        {
            ...
            "price": 7.95,
            "description": "100% Polyester—Machine wash—100% cationic polyester interlock—Pull On closure—Lightweight, roomy, highly breathable moisture-wicking fabric.",
            "category": "women's clothing",
